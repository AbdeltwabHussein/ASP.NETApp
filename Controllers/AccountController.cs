...
namespace webApp00.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<IdentityUser> userManager, SignInManager<IdentityUser> signInManager, IMapper _mapper)
        {
            ...
            try
            {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (user != null)
                    {
                        ...
                        using (var stream = new StreamWriter(@"E:\web design&Development\Sharp ASP.net Full stack course\BackEnd\Core\Session10\Token.txt"))
                        {
